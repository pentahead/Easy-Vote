      ...
      <div className="container py-5">
          ...
          <div className="col-12">
            <div className="hero-section text-center p-5 mb-5">
              <img
                ...
                alt="easy vote logo"
              />
              <h4 className=" gradient-text mb-3">
                EasyVote
                <span className="badge align-middle">2.0</span>
              </h4>
              <p className="lead mb-4">
                Mengubah Pemungutan Suara di Lingkungan Akademik Lebih baik
                Melalui Teknologi Blockchain yang Cerdas dan Aman
              </p>
              <div className="d-flex justify-content-center gap-3">
                <a
                  href="/vote"
                  className="btn btn-primary-custom btn-lg shadow"
                >
                  Vote Sekarang
                </a>
                <a href="/candidate" className="btn btn-outline-primary btn-lg">
                  Pelajari Kandidat
                </a>
              </div>
            </div>
          ...
          <div className="col-12">
            <div className="cta-academic-section text-center p-5 rounded-4 position-relative">
              <div className="container">
                <h2 className="display-5 mb-4 text-white">Ubah Wawasan Anda</h2>
                <p className="lead text-white-50 mb-5">
                  Bentuk Pemanfaatan Teknologi cerdas, aman, dan
                  terdesentrasliasi.
                </p>
                <div className="d-flex flex-column flex-md-row justify-content-center gap-3">
                  <a
                    href="/vote"
                    className="btn btn-cta-primary btn-lg shadow-lg"
                  >
                    Vote Sekarang
                  </a>
                  <a href="/statistic" className="btn btn-cta-outline btn-lg">
                    Lihat Statistik
                  </a>
                </div>
            ...
            <div className="card feature-card teal-card border-start border-5">
              <div className="card-body">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h3 className="card-title fw-bold text-teal-800 fs-3">
                    Data Real-Time
                  </h3>
                </div>
              </div>
            ...
            <div className="card feature-card blue-card border-start border-5">
              <div className="card-body">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h3 className="card-title fw-bold text-blue-800 fs-3">
                    Anonimitas Aman
                  </h3>
                </div>
              </div>
            ...
            <div className="card feature-card purple-card border-start border-5">
              <div className="card-body">
                <div className="d-flex align-items-center mb-3">
                  ...
                  <h3 className="card-title fw-bold text-purple-800 fs-3">
                    Analitik Lanjutan
                  </h3>
                </div>
              </div>
        ...
        <section className="workflow-container">
          <div className="workflow-header">
            <h2>Perjalanan Pemungutan Suara Anda yang Lebih Canggih</h2>
            <p className="lead">Tiga Keunggulan Blockchain</p>
          </div>
          ...
          <div className="row g-4">
            <div className="col-md-4">
              <div className="workflow-step workflow-step-teal text-center p-4 shadow-sm">
                ...
                <h4 className="fw-bold mb-3">Desain Keamanan yang Tinggi</h4>
                <p className="text-muted">
                  Blockchain menggunakan enkripsi dan algoritma konsensus yang
                  kuat untuk memastikan bahwa data yang tersimpan aman dan tidak
                  bisa diubah tanpa izin. Setiap transaksi yang dimasukkan ke
                  dalam blockchain dienkripsi, dan setelah dimasukkan, transaksi
                  tersebut tidak dapat diubah atau dihapus. Ini membuat
                  blockchain sangat aman dan dapat diandalkan, terutama untuk
                  aplikasi yang membutuhkan integritas data yang tinggi, seperti
                  transaksi keuangan atau identitas digital.
                </p>
              </div>
            </div>
            ...
            <div className="col-md-4">
              <div className="workflow-step workflow-step-blue text-center p-4 shadow-sm">
                <div className="workflow-icon">
                  ...
                  >
                    <g>
                      <g>
                        <path
                          d="M384.268,128.275H196.143c-4.427,0-8.017,3.588-8.017,8.017c0,4.428,3.589,8.017,8.017,8.017h26.188v60.393
                    ...
                    <g>
                      <g>
                        <path
                          d="M324.41,153.929c-4.427,0-8.017,3.588-8.017,8.017v17.102c0,4.428,3.589,8.017,8.017,8.017s8.017-3.588,8.017-8.017
                    ...
                    <g>
                      <g>
                        <path
                          d="M350.064,153.929c-4.427,0-8.017,3.588-8.017,8.017v17.102c0,4.428,3.589,8.017,8.017,8.017s8.017-3.589,8.017-8.017
                    ...
                    <g>
                      <g>
                        <path
                          d="M510.654,251.561l-34.205-51.307c-1.959-2.94-5.611-4.251-8.994-3.226c-3.381,1.023-5.694,4.14-5.694,7.672v17.637h-43.29
                    ...
                    <g>
                      <g>
                        <path
                          d="M93.529,222.338h-43.29v-17.637c0-3.533-2.313-6.65-5.694-7.673c-3.38-1.023-7.033,0.288-8.994,3.226L1.347,251.561
                    ...
                    <g>
                      <g>
                        <path
                          d="M314.98,467.463c-1.024-3.381-4.14-5.693-7.673-5.693h-17.637v-43.29c0-4.428-3.589-8.017-8.017-8.017h-51.307
                    ...
                    <g>
                      <g>
                        <path
                          d="M311.755,35.559L260.448,1.355c-2.694-1.796-6.201-1.796-8.893,0l-51.307,34.205c-2.997,1.998-4.305,5.876-3.133,9.281
                ...
                <h4 className="fw-bold mb-3">Desentraliasai</h4>
                <p className="text-muted">
                  Blockchain bersifat desentralisasi, artinya tidak ada satu
                  pihak tunggal yang mengontrol atau memiliki seluruh data dalam
                  jaringan. Transaksi disetujui oleh jaringan pengguna atau node
                  yang tersebar di berbagai lokasi. Hal ini mengurangi risiko
                  kegagalan sistem pusat dan membuat jaringan lebih tahan
                  terhadap serangan atau penyalahgunaan, karena tidak ada titik
                  pusat yang bisa diserang atau dipengaruhi oleh pihak luar.
                </p>
              </div>
            </div>
              ...
              <div className="workflow-step workflow-step-purple text-center p-4 shadow-sm">
                <div className="workflow-icon">
                  <svg
                    ...
                    x="0px"
                    y="0px"
                    viewBox="0 0 230.452 230.452"
                    enableBackground="new 0 0 230.452 230.452"
                  >
                    <path
                      d="M230.452,81.522v-53.25h-53.283v15h27.676L183.506,64.61c-13.38-26.507-40.85-44.738-72.513-44.738
                ...
                <p className="text-muted">
                  Setiap transaksi yang terjadi dalam blockchain tercatat secara
                  terbuka dan dapat diakses oleh semua pihak yang terlibat dalam
                  jaringan, memberikan tingkat transparansi yang tinggi. Selain
                  itu, karena setiap perubahan dicatat secara kronologis dalam
                  blok yang terhubung, blockchain memungkinkan audit yang mudah
                  dan transparan, sehingga dapat melacak riwayat transaksi
                  dengan mudah dan mengurangi potensi kecurangan atau
                  penyalahgunaan.
                </p>
              </div>
            </div>
          ...
          <div className="container">
            <div className="text-center mb-5">
              <h2 className="display-6 fw-bold text-dark mb-3">
                Blockchain Vote Transactions
              </h2>
              <p className="lead text-muted">
                Memuat history dari segala transaksi dalam block
              </p>
            </div>
